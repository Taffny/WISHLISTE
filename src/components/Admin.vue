...
const allOrders = Object.values(orders).map(order => { 
  ...
  return {
    ...order,
    //?: tenary operator is the same as a conditional statement, if the user or book is not found, it will return 'Unknown User' or 'Unknown Book'
...
//books
//1. create models
//2. Create a function to add a book
...
const firstName = ref(null) //ref makes it reactive 
        ...
        <v-form @submit.prevent >
            <v-card>
                ...
                <v-card-text>
                    ...
                    <v-row>
                        <v-col md="6">
                            <v-select :items="['Fiction', 'Non Fiction', 'Educational', 'Romance','Self Help']" v-model ="genre">
                            </v-select>
                        </v-col>
                    </v-row>
                </v-card-text>
